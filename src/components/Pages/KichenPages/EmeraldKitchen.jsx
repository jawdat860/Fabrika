...
import videoBg from "../../../assets/images/bg-video/zVideo.mp4";
    ...
    <div id="EmeraldKitchen" className="genn-EmeraldKitchen">
      ...
      <div className="genn-EmeraldKitchen-TextComponent">
        <TextComponent
          ...
          title={""}
          description={
            "Погрузитесь в атмосферу стиля с зелено-черной кухней, украшенной деревянными элементами. Создайте пространство, где каждая деталь радует глаз и вдохновляет на кулинарные шедевры!"
          }
        />
