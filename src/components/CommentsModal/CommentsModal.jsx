...
function CommentsModal() {
  ...
  const videos = [
   "https://l.okdeal.ru/video/commentVido1.mp4",
    "https://l.okdeal.ru/video/commentVido2.mp4",
   "https://l.okdeal.ru/video/commentVido1.mp4",
    "https://l.okdeal.ru/video/commentVido2.mp4",
   "https://l.okdeal.ru/video/commentVido1.mp4",
    "https://l.okdeal.ru/video/commentVido2.mp4",
          ...
          {videos.map((_, index) => (
            <SwiperSlide key={index}>
              <div
                ...
                style={{
                  backgroundImage: `url(${index % 2 === 0 ? image1 : image2})`,
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                }}
              >
                <div>{LocalText.CommentsModal.titlePhoto1}</div>
